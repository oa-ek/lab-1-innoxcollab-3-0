        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Events_Investors_InvestorId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("4122dea3-6bad-43e8-943f-a145153110c4"), "Акселератор" },
                    { new Guid("4125d4b0-b357-4c7e-ac8e-64ee4bf9a7d9"), "Грант" },
                    { new Guid("adaef6e6-8917-4b1e-9137-e4c68b1b8d3c"), "Хакатон" }
                });
